...
class Maerdo_Model_Componentcachebackendfileoption extends Maerdo_Model_Abstract {
	...
	public function __construct() {
		$this->_mapper=new Maerdo_Model_Mappers_Componentcachebackendfileoption();    	
     ...
     *
     * @return  Maerdo_Model_Mappers_Componentcachebackendfileoption     *
     */       
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new  Maerdo_Model_Mappers_Componentcachebackendfileoption());
        }
        return $this->_mapper;
    }
