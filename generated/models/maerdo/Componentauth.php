...
class Maerdo_Model_Componentauth extends Maerdo_Model_Abstract {
	...
	public function __construct() {
		$this->_mapper=new Maerdo_Model_Mappers_Componentauth();    	
     ...
     *
     * @return  Maerdo_Model_Mappers_Componentauth     *
     */       
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new  Maerdo_Model_Mappers_Componentauth());
        }
        return $this->_mapper;
    }
