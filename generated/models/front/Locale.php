...
class Front_Model_Locale extends Front_Model_Abstract {
	...
	public function __construct() {
		$this->_mapper=new Front_Model_Mappers_Locale();    	
     ...
     *
     * @return  Front_Model_Mappers_Locale     *
     */       
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new  Front_Model_Mappers_Locale());
        }
        return $this->_mapper;
    }
