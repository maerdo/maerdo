...
class Front_Model_Mappers_Form extends Front_Model_Mappers_Abstract {

    public function getDbTable()  {
       if (null === $this->_dbTable) {
            $this->setDbTable('Front_Model_Dbtable_Form');
       }
     ...
     * saves current row
     *
     * @param Front_Model_Form $model
     *
     */
     
    public function save(Front_Model_Form $model,$ignoreEmptyValuesOnUpdate=true) {
     ...
     *
     * @param new Front_Model_Form $model
     * @return array
     *
     */
