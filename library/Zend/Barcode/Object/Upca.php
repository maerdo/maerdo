...
php php*php php@versionphp php php php php$Idphp:php Upcaphp.phpphp php2php1php6php6php7php php2php0php1php0php-php0php3php-php2php8php php1php7php:php4php5php:php1php4Zphp mikaelkaelphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Barcodephp_Objectphp_Upcaphp extendsphp Zendphp_Barcodephp_Objectphp_Eanphp1php3
php{
...
php php php php php php php php php$encodedDataphp php php php php php=php php(php7php php*php php$thisphp-php>php_barThinWidthphp)php php*php php$thisphp-php>php_factorphp php*php php1php2php;
...
php php php php php php php php php/php/php Firstphp character
php php php php php php php php php$barsphp php=php strphp_splitphp(php$thisphp-php>php_codingMapphp[php'Aphp'php]php[php$textTablephp[php0php]php]php)php;
php php php php php php php php foreachphp php(php$barsphp asphp php$bphp)php php{
php php php php php php php php php php php php php$barcodeTablephp[php]php php=php arrayphp(php$bphp php,php php$thisphp-php>php_barThinWidthphp php,php php0php php,php php$heightphp)php;
php php php php php php php php php}

php php php php php php php php php/php/php Firstphp part
php php php php php php php php forphp php(php$iphp php=php php1php;php php$iphp <php php6php;php php$iphp+php+php)php php{
...
php php php php php php php php forphp php(php$iphp php=php php6php;php php$iphp <php php1php1php;php php$iphp+php+php)php php{
...
php php php php php php php php php/php/php Lastphp character
php php php php php php php php php$barsphp php=php strphp_splitphp(php$thisphp-php>php_codingMapphp[php'Cphp'php]php[php$textTablephp[php1php1php]php]php)php;
php php php php php php php php foreachphp php(php$barsphp asphp php$bphp)php php{
php php php php php php php php php php php php php$barcodeTablephp[php]php php=php arrayphp(php$bphp php,php php$thisphp-php>php_barThinWidthphp php,php php0php php,php php$heightphp)php;
php php php php php php php php php}
...
php php php php php php php php php php php php php php php php ifphp php(php$iphp php=php=php php0php php|php|php php$iphp php=php=php php1php1php)php php{
...
php php php php php php php php php php php php php php php php php php php php php php php php php$factorphp php=php php1php0php;
php php php php php php php php php php php php php php php php php php php php php php php php breakphp;
php php php php php php php php php php php php php php php php php php php php casephp php5php:
...
php php php php php php php php php php php php php php php php php php php php php php php php php$factorphp php=php php1php1php;
php php php php php php php php php php php php php php php php php php php php php php php php breakphp;
