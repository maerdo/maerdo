...
php php*php php@versionphp php php php php$Idphp:php Mysqlphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Classphp forphp connectingphp tophp MySQLphp databasesphp andphp performingphp commonphp operationsphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Db
php php*php php@subpackagephp Adapter
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Dbphp_Adapterphp_Pdophp_Mysqlphp extendsphp Zendphp_Dbphp_Adapterphp_Pdophp_Abstract
php{
...
php php php php php php*php/
php php php php protectedphp php$php_pdoTypephp php=php php'mysqlphp'php;
...
php php php php php php php php php php php php php$initCommandphp php=php php"SETphp NAMESphp php'php"php php.php php$thisphp-php>php_configphp[php'charsetphp'php]php php.php php"php'php"php;
php php php php php php php php php php php php php$thisphp-php>php_configphp[php'driverphp_optionsphp'php]php[php1php0php0php2php]php php=php php$initCommandphp;php php/php/php php1php0php0php2php php=php PDOphp:php:MYSQLphp_ATTRphp_INITphp_COMMAND
php php php php php php php php php}
...
php php php php php{
php php php php php php php php returnphp php$thisphp-php>fetchColphp(php'SHOWphp TABLESphp'php)php;
php php php php php}
...
php php php php php{
php php php php php php php php php/php/php php@todophp php usephp INFORMATIONphp_SCHEMAphp somedayphp whenphp MySQLphp's
php php php php php php php php php/php/php implementationphp hasphp reasonablyphp goodphp performancephp and
php php php php php php php php php/php/php thephp versionphp withphp thisphp improvementphp isphp inphp widephp usephp.
...
php php php php php php php php php$fieldphp php php php=php php0php;
php php php php php php php php php$typephp php php php php=php php1php;
php php php php php php php php php$nullphp php php php php=php php2php;
php php php php php php php php php$keyphp php php php php php=php php3php;
php php php php php php php php php$defaultphp php=php php4php;
php php php php php php php php php$extraphp php php php=php php5php;
...
php php php php php php php php foreachphp php(php$resultphp asphp php$rowphp)php php{
php php php php php php php php php php php php listphp(php$lengthphp,php php$scalephp,php php$precisionphp,php php$unsignedphp,php php$primaryphp,php php$primaryPositionphp,php php$identityphp)
php php php php php php php php php php php php php php php php php=php arrayphp(nullphp,php nullphp,php nullphp,php nullphp,php falsephp,php nullphp,php falsephp)php;
php php php php php php php php php php php php ifphp php(pregphp_matchphp(php'php/unsignedphp/php'php,php php$rowphp[php$typephp]php)php)php php{
php php php php php php php php php php php php php php php php php$unsignedphp php=php truephp;
php php php php php php php php php php php php php}
php php php php php php php php php php php php ifphp php(pregphp_matchphp(php'php/php^php(php(php?php:varphp)php?charphp)php\php(php(php\dphp+php)php\php)php/php'php,php php$rowphp[php$typephp]php,php php$matchesphp)php)php php{
...
php php php php php php php php php php php php php}php elsephp ifphp php(pregphp_matchphp(php'php/php^decimalphp\php(php(php\dphp+php)php,php(php\dphp+php)php\php)php/php'php,php php$rowphp[php$typephp]php,php php$matchesphp)php)php php{
...
php php php php php php php php php php php php php}php elsephp ifphp php(pregphp_matchphp(php'php/php^floatphp\php(php(php\dphp+php)php,php(php\dphp+php)php\php)php/php'php,php php$rowphp[php$typephp]php,php php$matchesphp)php)php php{
php php php php php php php php php php php php php php php php php$rowphp[php$typephp]php php=php php'floatphp'php;
php php php php php php php php php php php php php php php php php$precisionphp php=php php$matchesphp[php1php]php;
php php php php php php php php php php php php php php php php php$scalephp php=php php$matchesphp[php2php]php;
php php php php php php php php php php php php php}php elsephp ifphp php(pregphp_matchphp(php'php/php^php(php(php?php:bigphp|mediumphp|smallphp|tinyphp)php?intphp)php\php(php(php\dphp+php)php\php)php/php'php,php php$rowphp[php$typephp]php,php php$matchesphp)php)php php{
php php php php php php php php php php php php php php php php php$rowphp[php$typephp]php php=php php$matchesphp[php1php]php;
...
php php php php php php php php php php php php php}
php php php php php php php php php php php php ifphp php(strtoupperphp(php$rowphp[php$keyphp]php)php php=php=php php'PRIphp'php)php php{
...
php php php php php php php php php php php php php php php php ifphp php(php$rowphp[php$extraphp]php php=php=php php'autophp_incrementphp'php)php php{
php php php php php php php php php php php php php php php php php php php php php$identityphp php=php truephp;
php php php php php php php php php php php php php php php php php}php elsephp php{
php php php php php php php php php php php php php php php php php php php php php$identityphp php=php falsephp;
php php php php php php php php php php php php php php php php php}
php php php php php php php php php php php php php php php php php+php+php$pphp;
php php php php php php php php php php php php php}
php php php php php php php php php php php php php$descphp[php$thisphp-php>foldCasephp(php$rowphp[php$fieldphp]php)php]php php=php arrayphp(
...
php php php php php php php php php php php php php php php php php'COLUMNphp_NAMEphp'php php php php php php php=php>php php$thisphp-php>foldCasephp(php$rowphp[php$fieldphp]php)php,
...
php php php php php php php php php php php php php php php php php'NULLABLEphp'php php php php php php php php php php=php>php php(boolphp)php php(php$rowphp[php$nullphp]php php=php=php php'YESphp'php)php,
...
php php php php php php php php php php php php php php php php php'UNSIGNEDphp'php php php php php php php php php php=php>php php$unsignedphp,
...
php php php php php php*php php@paramphp php integerphp php$offsetphp OPTIONAL
php php php php php php*php php@throwsphp Zendphp_Dbphp_Adapterphp_Exception
php php php php php php*php php@returnphp string
php php php php php php*php/
