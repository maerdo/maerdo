...
php php*php php@versionphp php php php php$Idphp:php Ociphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Classphp forphp connectingphp tophp Oraclephp databasesphp andphp performingphp commonphp operationsphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Db
php php*php php@subpackagephp Adapter
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Dbphp_Adapterphp_Pdophp_Ociphp extendsphp Zendphp_Dbphp_Adapterphp_Pdophp_Abstract
php{
...
php php php php php php*php/
php php php php protectedphp php$php_pdoTypephp php=php php'ociphp'php;
...
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_defaultStmtClassphp php=php php'Zendphp_Dbphp_Statementphp_Pdophp_Ociphp'php;
...
php php php php php php php php php'NUMBERphp'php php php php php php php php php php php php php php=php>php Zendphp_Dbphp:php:FLOATphp_TYPE
php php php php php)php;
...
php php php php php php php php ifphp php(issetphp(php$dsnphp[php'hostphp'php]php)php)php php{
php php php php php php php php php php php php php$tnsphp php=php php'dbnamephp=php(DESCRIPTIONphp=php(ADDRESSphp_LISTphp=php(ADDRESSphp=php(PROTOCOLphp=TCPphp)php'php php.
php php php php php php php php php php php php php php php php php php php php'php(HOSTphp=php'php php.php php$dsnphp[php'hostphp'php]php php.php php'php)php'php;

php php php php php php php php php php php php ifphp php(issetphp(php$dsnphp[php'portphp'php]php)php)php php{
php php php php php php php php php php php php php php php php php$tnsphp php.php=php php'php(PORTphp=php'php php.php php$dsnphp[php'portphp'php]php php.php php'php)php'php;
php php php php php php php php php php php php php}php elsephp php{
php php php php php php php php php php php php php php php php php$tnsphp php.php=php php'php(PORTphp=php1php5php2php1php)php'php;
php php php php php php php php php php php php php}

php php php php php php php php php php php php php$tnsphp php.php=php php'php)php)php(CONNECTphp_DATAphp=php(SIDphp=php'php php.php php$dsnphp[php'dbnamephp'php]php php.php php'php)php)php)php'php;
php php php php php php php php php}php elsephp php{
php php php php php php php php php php php php php$tnsphp php=php php'dbnamephp=php'php php.php php$dsnphp[php'dbnamephp'php]php;
php php php php php php php php php}

php php php php php php php php ifphp php(issetphp(php$dsnphp[php'charsetphp'php]php)php)php php{
php php php php php php php php php php php php php$tnsphp php.php=php php'php;charsetphp=php'php php.php php$dsnphp[php'charsetphp'php]php;
php php php php php php php php php}

php php php php php php php php returnphp php$thisphp-php>php_pdoTypephp php.php php'php:php'php php.php php$tnsphp;
php php php php php}

php php php php php/php*php*
php php php php php php*php Quotephp aphp rawphp stringphp.
php php php php php php*php Mostphp PDOphp driversphp havephp anphp implementationphp forphp thephp quotephp(php)php methodphp,
php php php php php php*php butphp thephp Oraclephp OCIphp driverphp mustphp usephp thephp samephp implementationphp asphp the
php php php php php php*php Zendphp_Dbphp_Adapterphp_Abstractphp classphp.
php php php php php php*
...
php php php php php php php php php$valuephp php=php php$thisphp-php>fetchOnephp(php'SELECTphp php'php.php$thisphp-php>quoteIdentifierphp(php$sequenceNamephp,php truephp)php.php'php.CURRVALphp FROMphp dualphp'php)php;
...
php php php php php{
php php php php php php php php php$thisphp-php>php_connectphp(php)php;
php php php php php php php php php$valuephp php=php php$thisphp-php>fetchOnephp(php'SELECTphp php'php.php$thisphp-php>quoteIdentifierphp(php$sequenceNamephp,php truephp)php.php'php.NEXTVALphp FROMphp dualphp'php)php;
php php php php php php php php returnphp php$valuephp;
php php php php php}
...
php php php php php php php php php php php php php php php php php$sequenceNamephp php.php=php php$thisphp-php>foldCasephp(php"php_php$primaryKeyphp"php)php;
php php php php php php php php php php php php php}
php php php php php php php php php php php php php$sequenceNamephp php.php=php php$thisphp-php>foldCasephp(php'php_seqphp'php)php;
