...
php/php*php*
php php*php Zendphp_Dbphp_Tablephp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Dbphp/Tablephp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Dbphp_Tablephp_Rowsetphp_Exceptionphp extendsphp Zendphp_Dbphp_Tablephp_Exception
php{
php}
