...
php/php*php*php php@seephp Zendphp_Authphp_Adapterphp_Interfacephp php*php/
requirephp_oncephp php'Zendphp/Authphp/Adapterphp/Interfacephp.phpphp'php;

php/php*php*
php php*php Basephp abstractphp classphp forphp AMFphp authenticationphp implementation
php php*
php php*php php@packagephp php php php Zendphp_Amf
php php*php php@subpackagephp Auth
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
abstractphp classphp Zendphp_Amfphp_Authphp_Abstractphp implementsphp Zendphp_Authphp_Adapterphp_Interface
php{
php php php php protectedphp php$php_usernamephp;
php php php php protectedphp php$php_passwordphp;

php php php php publicphp functionphp setCredentialsphp(php$usernamephp,php php$passwordphp)php php{
