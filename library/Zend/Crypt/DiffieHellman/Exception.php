...
php/php*php*
php php*php php@seephp Zendphp_Cryptphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Cryptphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Cryptphp_DiffieHellmanphp_Exceptionphp extendsphp Zendphp_Cryptphp_Exception
php{
php}