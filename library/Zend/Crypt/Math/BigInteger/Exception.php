...
php/php*php*
php php*php php@seephp Zendphp_Cryptphp_Mathphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Cryptphp/Mathphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Cryptphp_Mathphp_BigIntegerphp_Exceptionphp extendsphp Zendphp_Cryptphp_Mathphp_Exception
php{
php}