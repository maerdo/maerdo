...
php php*php php@versionphp php php php php$Idphp:php Bodyphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/

php/php*php*
php php*php php@seephp Zendphp_CodeGeneratorphp_Abstract
php php*php/
requirephp_oncephp php'Zendphp/CodeGeneratorphp/Abstractphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_CodeGeneratorphp_Phpphp_Bodyphp extendsphp Zendphp_CodeGeneratorphp_Abstract
php{
...
php php php php php php*php php@returnphp Zendphp_CodeGeneratorphp_Phpphp_Body
php php php php php php*php/
...
php php php php php{
php php php php php php php php returnphp php(stringphp)php php$thisphp-php>php_contentphp;
php php php php php}
