...
php/php*php*
php php*php php@seephp Zendphp_Loaderphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Loaderphp/Exceptionphp.phpphp'php;

php/php*php*
php php*php Pluginphp classphp loaderphp exceptions
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Loader
php php*php php@subpackagephp PluginLoader
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Loaderphp_PluginLoaderphp_Exceptionphp extendsphp Zendphp_Loaderphp_Exception
php{
php}
