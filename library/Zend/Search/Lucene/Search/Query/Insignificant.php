...
php php*php php@versionphp php php php php$Idphp:php Insignificantphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Thephp insignificantphp queryphp returnsphp emptyphp resultphp,php butphp doesnphp'tphp limitphp resultphp setphp asphp aphp partphp ofphp otherphp queries
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Searchphp_Lucene
php php*php php@subpackagephp Search
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Searchphp_Lucenephp_Searchphp_Queryphp_Insignificantphp extendsphp Zendphp_Searchphp_Lucenephp_Searchphp_Query
php{
...
php php php php php{
php php php php php php php php returnphp php'php<InsignificantQueryphp>php'php;
php php php php php}
php}
