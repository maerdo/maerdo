...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Searchphp_Lucenephp_Searchphp_Weightphp_Termphp extendsphp Zendphp_Searchphp_Lucenephp_Searchphp_Weight
php{
...
php php php php php/php*php*
php php php php php php*php Term
php php php php php php*
...
php php php php php php*php php@varphp float
php php php php php php*php/
php php php php privatephp php$php_queryWeightphp;


php php php php php/php*php*
php php php php php php*php Zendphp_Searchphp_Lucenephp_Searchphp_Weightphp_Termphp constructor
php php php php php php*php readerphp php-php indexphp reader
php php php php php php*
php php php php php php*php php@paramphp Zendphp_Searchphp_Lucenephp_Indexphp_Termphp php php php$term
...
php php php php php php*php/
php php php php publicphp functionphp php_php_constructphp(Zendphp_Searchphp_Lucenephp_Indexphp_Termphp php php php$termphp,
php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php Zendphp_Searchphp_Lucenephp_Searchphp_Queryphp php$queryphp,
...
php php php php php{
php php php php php php php php php$thisphp-php>php_termphp php php php=php php$termphp;
...
php php php php php php php php php$thisphp-php>php_idfphp php=php php$thisphp-php>php_readerphp-php>getSimilarityphp(php)php-php>idfphp(php$thisphp-php>php_termphp,php php$thisphp-php>php_readerphp)php;
