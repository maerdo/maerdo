...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Searchphp_Lucenephp_Searchphp_Weightphp_Booleanphp extendsphp Zendphp_Searchphp_Lucenephp_Searchphp_Weight
php{
...
php php php php php/php*php*
php php php php php php*php Queriesphp weights
...
php php php php php/php*php*
php php php php php php*php Zendphp_Searchphp_Lucenephp_Searchphp_Weightphp_Booleanphp constructor
...
php php php php php php php php foreachphp php(php$queryphp-php>getSubqueriesphp(php)php asphp php$numphp php=php>php php$subqueryphp)php php{
php php php php php php php php php php php php ifphp php(php$signsphp php=php=php=php nullphp php|php|php php$signsphp[php$numphp]php php=php=php=php nullphp php|php|php php$signsphp[php$numphp]php)php php{
php php php php php php php php php php php php php php php php php$thisphp-php>php_weightsphp[php$numphp]php php=php php$subqueryphp-php>createWeightphp(php$readerphp)php;
