...
php php*php php@versionphp php php php php$Idphp:php Utfphp8php.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
classphp Zendphp_Searchphp_Lucenephp_Analysisphp_Analyzerphp_Commonphp_Utfphp8php extendsphp Zendphp_Searchphp_Lucenephp_Analysisphp_Analyzerphp_Common
php{
...
php php php php php php php php php php php php throwphp newphp Zendphp_Searchphp_Lucenephp_Exceptionphp(php'Utfphp8php analyzerphp needsphp PCREphp unicodephp supportphp tophp bephp enabledphp.php'php)php;
...
php php php php php php php php php php php php ifphp php(php!php pregphp_matchphp(php'php/php[php\pphp{Lphp}php]php+php/uphp'php,php php$thisphp-php>php_inputphp,php php$matchphp,php PREGphp_OFFSETphp_CAPTUREphp,php php$thisphp-php>php_bytePositionphp)php)php php{
