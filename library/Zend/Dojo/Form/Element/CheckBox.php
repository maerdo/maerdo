...
php php*php/
classphp Zendphp_Dojophp_Formphp_Elementphp_CheckBoxphp extendsphp Zendphp_Dojophp_Formphp_Elementphp_Dijit
php{
...
php php php php php php*php/
php php php php publicphp php$helperphp php=php php'CheckBoxphp'php;
