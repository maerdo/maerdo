...
php/php*php*
php php*php CheckBoxphp dijit
php php*
php php*php Notephp:php thisphp wouldphp bephp easierphp withphp mixinsphp orphp traitsphp.php.php.
php php*
...
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php php@versionphp php php php php$Idphp:php DijitMultiphp.phpphp php2php2php3php2php2php php2php0php1php0php-php0php5php-php3php0php php1php1php:php1php2php:php5php7Zphp thomasphp php$
php php*php/
abstractphp classphp Zendphp_Dojophp_Formphp_Elementphp_DijitMultiphp extendsphp Zendphp_Dojophp_Formphp_Elementphp_Dijit
php{
...
php php php php php php php php php php php php php php php php php$optionsphp php=php php$thisphp-php>getMultiOptionsphp(php)php;
...
php php php php php php php php php php php php php php php php php php php php arrayphp(arrayphp_keysphp(php$optionsphp)php)
...
php php php php php{
php php php php php php php php ifphp php(php!issetphp(php$thisphp-php>php_translatedphp[php$optionphp]php)php)php php{
...
php php php php php/php*php*
php php php php php php*php Translatephp aphp value
php php php php php php*
