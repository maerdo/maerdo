...
php/php*php*
php php*php Dojophp CurrencyTextBoxphp dijit
php php*
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php php*php/
classphp Zendphp_Dojophp_Viewphp_Helperphp_CurrencyTextBoxphp extendsphp Zendphp_Dojophp_Viewphp_Helperphp_Dijit
php{
php php php php php/php*php*
php php php php php php*php Dijitphp beingphp used
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_dijitphp php php=php php'dijitphp.formphp.CurrencyTextBoxphp'php;
...
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_modulephp php=php php'dijitphp.formphp.CurrencyTextBoxphp'php;

php php php php php/php*php*
php php php php php php*php dijitphp.formphp.CurrencyTextBox
...
php php php php php php*php/
php php php php publicphp functionphp currencyTextBoxphp(php$idphp,php php$valuephp php=php nullphp,php arrayphp php$paramsphp php=php arrayphp(php)php,php arrayphp php$attribsphp php=php arrayphp(php)php)
php php php php php{
