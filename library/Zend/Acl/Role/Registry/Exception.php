...
php/php*php*
php php*php php@seephp Zendphp_Aclphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Aclphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Aclphp_Rolephp_Registryphp_Exceptionphp extendsphp Zendphp_Aclphp_Exception
php{php}
