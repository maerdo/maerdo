...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Aclphp_Resourcephp_Interface
php{
php php php php php/php*php*
php php php php php php*php Returnsphp thephp stringphp identifierphp ofphp thephp Resource
php php php php php php*
php php php php php php*php php@returnphp string
php php php php php php*php/
php php php php publicphp functionphp getResourceIdphp(php)php;
php}
