...
php/php*php*
php php*php Memoryphp valuephp containerphp interface
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Memory
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Memoryphp_Containerphp_Interface
php{
...
php php php php php php*php/
php php php php publicphp functionphp php&getRefphp(php)php;
...
php php php php php php*php/
php php php php publicphp functionphp touchphp(php)php;

php php php php php/php*php*
php php php php php php*php Lockphp objectphp inphp memoryphp.
php php php php php php*php/
php php php php publicphp functionphp lockphp(php)php;

php php php php php/php*php*
php php php php php php*php Unlockphp object
php php php php php php*php/
php php php php publicphp functionphp unlockphp(php)php;
...
php php php php php php*php/
php php php php publicphp functionphp isLockedphp(php)php;
php}
