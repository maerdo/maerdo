...
php php*php php@versionphp php php php php$Idphp:php FormFilephp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Helperphp tophp generatephp aphp php"filephp"php element
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_View
php php*php php@subpackagephp Helper
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Viewphp_Helperphp_FormFilephp extendsphp Zendphp_Viewphp_Helperphp_FormElement
php{
php php php php php/php*php*
php php php php php php*php Generatesphp aphp php'filephp'php elementphp.
...
php php php php php php*php/
php php php php publicphp functionphp formFilephp(php$namephp,php php$attribsphp php=php nullphp)
php php php php php{
php php php php php php php php php$infophp php=php php$thisphp-php>php_getInfophp(php$namephp,php nullphp,php php$attribsphp)php;
...
php php php php php php php php php$xhtmlphp php=php php'php<inputphp typephp=php"filephp"php'
