...
php/php*php*
php php*php php@seephp Zendphp_Viewphp_Helperphp_Interface
php php*php/
requirephp_oncephp php'Zendphp/Viewphp/Helperphp/Interfacephp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
abstractphp classphp Zendphp_Viewphp_Helperphp_Abstractphp implementsphp Zendphp_Viewphp_Helperphp_Interface
php{
...
php php php php php php*php php@returnphp Zendphp_Viewphp_Helperphp_Abstract
php php php php php php*php/
...
php php php php php/php*php*
php php php php php php*php Strategyphp patternphp:php currentlyphp unutilized
php php php php php php*
