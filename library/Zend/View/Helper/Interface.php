...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Viewphp_Helperphp_Interface
php{
...
php php php php php php*php php@returnphp Zendphp_Viewphp_Helperphp_Interface
php php php php php php*php/
php php php php publicphp functionphp setViewphp(Zendphp_Viewphp_Interfacephp php$viewphp)php;

php php php php php/php*php*
php php php php php php*php Strategyphp patternphp:php helperphp methodphp tophp invoke
php php php php php php*
php php php php php php*php php@returnphp mixed
php php php php php php*php/
php php php php publicphp functionphp directphp(php)php;
php}
