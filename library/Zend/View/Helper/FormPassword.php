...
php php*php php@versionphp php php php php$Idphp:php FormPasswordphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Helperphp tophp generatephp aphp php"passwordphp"php element
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_View
php php*php php@subpackagephp Helper
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Viewphp_Helperphp_FormPasswordphp extendsphp Zendphp_Viewphp_Helperphp_FormElement
php{
php php php php php/php*php*
php php php php php php*php Generatesphp aphp php'passwordphp'php elementphp.
...
php php php php php php*php/
php php php php publicphp functionphp formPasswordphp(php$namephp,php php$valuephp php=php nullphp,php php$attribsphp php=php nullphp)
php php php php php{
...
php php php php php php php php php php php php php/php/php disabled
...
php php php php php php php php php/php/php determinephp thephp XHTMLphp value
php php php php php php php php php$valueStringphp php=php php'php valuephp=php"php"php'php;
php php php php php php php php ifphp php(arrayphp_keyphp_existsphp(php'renderPasswordphp'php,php php$attribsphp)php)php php{
php php php php php php php php php php php php ifphp php(php$attribsphp[php'renderPasswordphp'php]php)php php{
php php php php php php php php php php php php php php php php php$valueStringphp php=php php'php valuephp=php"php'php php.php php$thisphp-php>viewphp-php>escapephp(php$valuephp)php php.php php'php"php'php;
php php php php php php php php php php php php php}
php php php php php php php php php php php php unsetphp(php$attribsphp[php'renderPasswordphp'php]php)php;
php php php php php php php php php}
...
php php php php php php php php php/php/php renderphp thephp element
php php php php php php php php php$xhtmlphp php=php php'php<inputphp typephp=php"passwordphp"php'
...
php php php php php php php php php php php php php php php php php.php php$valueString
