...
php php*php php@versionphp php php php php$Idphp:php Urlphp.phpphp php2php0php6php6php3php php2php0php1php0php-php0php1php-php2php6php php1php8php:php4php5php:php1php8Zphp kokxphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Markupphp_Rendererphp_Htmlphp_Urlphp extendsphp Zendphp_Markupphp_Rendererphp_Htmlphp_HtmlAbstract
php{
...
php php php php php{
php php php php php php php php ifphp php(php$tokenphp-php>hasAttributephp(php'urlphp'php)php)php php{
php php php php php php php php php php php php php$uriphp php=php php$tokenphp-php>getAttributephp(php'urlphp'php)php;
php php php php php php php php php}php elsephp php{
php php php php php php php php php php php php php$uriphp php=php php$textphp;
...
php php php php php php php php php$attributesphp php=php Zendphp_Markupphp_Rendererphp_Htmlphp:php:renderAttributesphp(php$tokenphp)php;

php php php php php php php php php/php/php runphp thephp URIphp throughphp htmlentities
...
php php php php php php php php returnphp php"php<aphp hrefphp=php\php"php{php$uriphp}php\php"php{php$attributesphp}php>php{php$textphp}<php/aphp>php"php;
php php php php php}
