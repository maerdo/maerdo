...
php php*php php@versionphp php php php php$Idphp:php Codephp.phpphp php2php0php2php7php0php php2php0php1php0php-php0php1php-php1php3php php2php2php:php3php7php:php4php1Zphp kokxphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Markupphp_Rendererphp_Htmlphp_Codephp extendsphp Zendphp_Markupphp_Rendererphp_Htmlphp_HtmlAbstract
php{
...
php php php php php{
php php php php php php php php returnphp highlightphp_stringphp(php$textphp,php truephp)php;
php php php php php}
