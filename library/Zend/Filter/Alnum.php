...
php php*php php@versionphp php php php php$Idphp:php Alnumphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Filterphp_Alnumphp implementsphp Zendphp_Filterphp_Interface
php{
...
php php php php php php*
php php php php php php*php Returnsphp thephp stringphp php$valuephp,php removingphp allphp butphp alphabeticphp andphp digitphp characters
php php php php php php*
...
php php php php php php php php php php php php php/php/php POSIXphp namedphp classesphp arephp notphp supportedphp,php usephp alternativephp aphp-zAphp-Zphp0php-php9php match
php php php php php php php php php php php php php$patternphp php=php php'php/php[php^aphp-zAphp-Zphp0php-php9php'php php.php php$whiteSpacephp php.php php'php]php/php'php;
...
php php php php php php php php php php php php php$patternphp php=php php'php/php[php^aphp-zAphp-Zphp0php-php9php'php php php.php php$whiteSpacephp php.php php'php]php/uphp'php;
...
php php php php php php php php php php php php php$patternphp php=php php'php/php[php^php\pphp{Lphp}php\pphp{Nphp}php'php php.php php$whiteSpacephp php.php php'php]php/uphp'php;
php php php php php php php php php}
