...
php/php*php*
php php*php Decryptsphp aphp givenphp string
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Filter
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Filterphp_Decryptphp extendsphp Zendphp_Filterphp_Encrypt
php{
php php php php php/php*php*
php php php php php php*php Definedphp byphp Zendphp_Filterphp_Interface
php php php php php php*
php php php php php php*php Decryptsphp thephp contentphp php$valuephp withphp thephp definedphp settings
php php php php php php*
...
php php php php php{
php php php php php php php php returnphp php$thisphp-php>php_adapterphp-php>decryptphp(php$valuephp)php;
php php php php php}
php}
