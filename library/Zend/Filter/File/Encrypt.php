...
php/php*php*
php php*php php@seephp Zendphp_Filterphp_Encrypt
php php*php/
requirephp_oncephp php'Zendphp/Filterphp/Encryptphp.phpphp'php;

php/php*php*
php php*php Encryptsphp aphp givenphp filephp andphp storesphp thephp encryptedphp filephp content
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Filter
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Filterphp_Filephp_Encryptphp extendsphp Zendphp_Filterphp_Encrypt
php{
...
php php php php php php*
php php php php php php*php Encryptsphp thephp filephp php$valuephp withphp thephp definedphp settings
php php php php php php*
...
php php php php php php php php php$encryptedphp php=php parentphp:php:filterphp(php$contentphp)php;
php php php php php php php php php$resultphp php php php php=php filephp_putphp_contentsphp(php$thisphp-php>php_filenamephp,php php$encryptedphp)php;
