...
php php*php php@versionphp php php php php$Idphp:php UpperCasephp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/

php/php*php*
php php*php php@seephp Zendphp_Filterphp_StringToUpper
php php*php/
requirephp_oncephp php'Zendphp/Filterphp/StringToUpperphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Filterphp_Filephp_UpperCasephp extendsphp Zendphp_Filterphp_StringToUpper
php{
