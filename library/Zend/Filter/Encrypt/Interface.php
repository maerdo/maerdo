...
php/php*php*
php php*php Encryptionphp interface
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Filter
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Filterphp_Encryptphp_Interface
php{
php php php php php/php*php*
php php php php php php*php Encryptsphp php$valuephp withphp thephp definedphp settings
php php php php php php*
php php php php php php*php php@paramphp php stringphp php$valuephp Dataphp tophp encrypt
php php php php php php*php php@returnphp stringphp Thephp encryptedphp data
php php php php php php*php/
php php php php publicphp functionphp encryptphp(php$valuephp)php;

php php php php php/php*php*
php php php php php php*php Decryptsphp php$valuephp withphp thephp definedphp settings
php php php php php php*
php php php php php php*php php@paramphp php stringphp php$valuephp Dataphp tophp decrypt
php php php php php php*php php@returnphp stringphp Thephp decryptedphp data
php php php php php php*php/
php php php php publicphp functionphp decryptphp(php$valuephp)php;
php}
