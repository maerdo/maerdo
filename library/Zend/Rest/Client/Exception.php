...
php/php*php*
php php*php Zendphp_Restphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Restphp/Exceptionphp.phpphp'php;


php/php*php*
php php*php Zendphp_Restphp_Serverphp_Exception
php php*
php php*php php@packagephp php php php Zendphp_Rest
php php*php php@subpackagephp Client
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Restphp_Clientphp_Exceptionphp extendsphp Zendphp_Restphp_Exception
php{
php}
