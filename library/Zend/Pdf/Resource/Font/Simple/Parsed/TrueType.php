...
php/php*php*php Zendphp_Pdfphp_Resourcephp_Fontphp_Simplephp_Parsedphp php*php/
requirephp_oncephp php'Zendphp/Pdfphp/Resourcephp/Fontphp/Simplephp/Parsedphp.phpphp'php;

php/php*php*
php php*php TrueTypephp fontsphp implementation
php php*
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Resourcephp_Fontphp_Simplephp_Parsedphp_TrueTypephp extendsphp Zendphp_Pdfphp_Resourcephp_Fontphp_Simplephp_Parsed
php{
...
php php php php php php php php php$thisphp-php>php_fontTypephp php=php Zendphp_Pdfphp_Fontphp:php:TYPEphp_TRUETYPEphp;

php php php php php php php php php$thisphp-php>php_resourcephp-php>Subtypephp php php=php newphp Zendphp_Pdfphp_Elementphp_Namephp(php'TrueTypephp'php)php;
