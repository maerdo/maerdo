...
php/php*php*
php php*php PDFphp filephp php'nullphp'php elementphp implementation
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Pdf
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Elementphp_Nullphp extendsphp Zendphp_Pdfphp_Element
php{
php php php php php/php*php*
php php php php php php*php Objectphp valuephp.php Alwaysphp nullphp.
...
php php php php php{
php php php php php php php php php$thisphp-php>valuephp php=php nullphp;
php php php php php}
...
php php php php php{
php php php php php php php php returnphp Zendphp_Pdfphp_Elementphp:php:TYPEphp_NULLphp;
php php php php php}
...
php php php php php{
php php php php php php php php returnphp php'nullphp'php;
php php php php php}
php}
