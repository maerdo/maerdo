...
php php*php php@versionphp php php php php$Idphp:php FitBoundingBoxVerticallyphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Zendphp_Pdfphp_Destinationphp_FitBoundingBoxVerticallyphp explicitphp detination
php php*
php php*php Destinationphp arrayphp:php php[pagephp php/FitBVphp leftphp]
php php*
php php*php php(PDFphp php1php.php1php)php Displayphp thephp pagephp designatedphp byphp pagephp,php withphp thephp horizontalphp coordinate
php php*php leftphp positionedphp atphp thephp leftphp edgephp ofphp thephp windowphp andphp thephp contentsphp ofphp thephp page
php php*php magnifiedphp justphp enoughphp tophp fitphp thephp entirephp heightphp ofphp itsphp boundingphp boxphp withinphp the
php php*php windowphp.
php php*
php php*php php@packagephp php php php Zendphp_Pdf
php php*php php@subpackagephp Destination
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Destinationphp_FitBoundingBoxVerticallyphp extendsphp Zendphp_Pdfphp_Destinationphp_Explicit
php{
...
php php php php php php*php php@returnphp Zendphp_Pdfphp_Destinationphp_FitBoundingBoxVertically
...
php php php php php php php php php$destinationArrayphp-php>itemsphp[php]php php=php newphp Zendphp_Pdfphp_Elementphp_Namephp(php'FitBVphp'php)php;
...
php php php php php php php php returnphp newphp Zendphp_Pdfphp_Destinationphp_FitBoundingBoxVerticallyphp(php$destinationArrayphp)php;
php php php php php}
...
php php php php php php*php php@returnphp Zendphp_Pdfphp_Actionphp_FitBoundingBoxVertically
php php php php php php*php/
