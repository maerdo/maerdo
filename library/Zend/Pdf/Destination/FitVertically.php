...
php php*php php@versionphp php php php php$Idphp:php FitVerticallyphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Zendphp_Pdfphp_Destinationphp_FitVerticallyphp explicitphp detination
php php*
php php*php Destinationphp arrayphp:php php[pagephp php/FitVphp leftphp]
php php*
php php*php Displayphp thephp pagephp designatedphp byphp pagephp,php withphp thephp horizontalphp coordinatephp leftphp positioned
php php*php atphp thephp leftphp edgephp ofphp thephp windowphp andphp thephp contentsphp ofphp thephp pagephp magnified
php php*php justphp enoughphp tophp fitphp thephp entirephp heightphp ofphp thephp pagephp withinphp thephp windowphp.
php php*
php php*php php@packagephp php php php Zendphp_Pdf
php php*php php@subpackagephp Destination
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Destinationphp_FitVerticallyphp extendsphp Zendphp_Pdfphp_Destinationphp_Explicit
php{
...
php php php php php php*php php@returnphp Zendphp_Pdfphp_Destinationphp_FitVertically
php php php php php php*php php@throwsphp Zendphp_Pdfphp_Exception
php php php php php php*php/
php php php php publicphp staticphp functionphp createphp(php$pagephp,php php$leftphp)
php php php php php{
...
php php php php php php php php php php php php throwphp newphp Zendphp_Pdfphp_Exceptionphp(php'Pagephp entryphp mustphp bephp aphp Zendphp_Pdfphp_Pagephp objectphp orphp pagephp numberphp.php'php)php;
php php php php php php php php php}

php php php php php php php php php$destinationArrayphp-php>itemsphp[php]php php=php newphp Zendphp_Pdfphp_Elementphp_Namephp(php'FitVphp'php)php;
...
php php php php php php php php returnphp newphp Zendphp_Pdfphp_Destinationphp_FitVerticallyphp(php$destinationArrayphp)php;
php php php php php}
...
php php php php php php*php php@returnphp Zendphp_Pdfphp_Actionphp_FitVertically
php php php php php php*php/
