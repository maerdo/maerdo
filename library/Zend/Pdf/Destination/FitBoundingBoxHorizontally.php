...
php php*php php@versionphp php php php php$Idphp:php FitBoundingBoxHorizontallyphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Zendphp_Pdfphp_Destinationphp_FitBoundingBoxHorizontallyphp explicitphp detination
php php*
php php*php Destinationphp arrayphp:php php[pagephp php/FitBHphp topphp]
php php*
php php*php php(PDFphp php1php.php1php)php Displayphp thephp pagephp designatedphp byphp pagephp,php withphp thephp verticalphp coordinate
php php*php topphp positionedphp atphp thephp topphp edgephp ofphp thephp windowphp andphp thephp contentsphp ofphp thephp page
php php*php magnifiedphp justphp enoughphp tophp fitphp thephp entirephp widthphp ofphp itsphp boundingphp boxphp withinphp the
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Destinationphp_FitBoundingBoxHorizontallyphp extendsphp Zendphp_Pdfphp_Destinationphp_Explicit
php{
...
php php php php php php*php php@returnphp Zendphp_Pdfphp_Destinationphp_FitBoundingBoxHorizontally
...
php php php php php php php php php$destinationArrayphp-php>itemsphp[php]php php=php newphp Zendphp_Pdfphp_Elementphp_Namephp(php'FitBHphp'php)php;
...
php php php php php php php php returnphp newphp Zendphp_Pdfphp_Destinationphp_FitBoundingBoxHorizontallyphp(php$destinationArrayphp)php;
php php php php php}
...
php php php php php php*php php@returnphp Zendphp_Pdfphp_Actionphp_FitBoundingBoxHorizontally
php php php php php php*php/
