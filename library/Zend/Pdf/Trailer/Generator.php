...
php php*php php@versionphp php php php php$Idphp:php Generatorphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php PDFphp filephp trailerphp generatorphp php(usedphp forphp justphp createdphp PDFphp)
php php*
php php*php php@packagephp php php php Zendphp_Pdf
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Trailerphp_Generatorphp extendsphp Zendphp_Pdfphp_Trailer
php{
...
php php php php php php php php returnphp strlenphp(Zendphp_Pdfphp:php:PDFphp_HEADERphp)php;
php php php php php}
...
php php php php php{
php php php php php php php php requirephp_oncephp php'Zendphp/Pdfphp.phpphp'php;
php php php php php php php php returnphp Zendphp_Pdfphp:php:PDFphp_HEADERphp;
php php php php php}
