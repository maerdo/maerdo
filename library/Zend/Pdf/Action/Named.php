...
php/php*php*
php php*php PDFphp php'Executephp anphp actionphp predefinedphp byphp thephp viewerphp applicationphp'php action
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Pdfphp_Actionphp_Namedphp extendsphp Zendphp_Pdfphp_Action
php{
php}
