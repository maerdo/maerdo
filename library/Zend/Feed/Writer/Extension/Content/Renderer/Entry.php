...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Feedphp_Writerphp_Extensionphp_Contentphp_Rendererphp_Entry
...
php php php php php php php php php$thisphp-php>php_setContentphp(php$thisphp-php>php_domphp,php php$thisphp-php>php_basephp)php;
...
php php php php php/php*php*
php php php php php php*php Appendphp namespacesphp tophp rootphp element
php php php php php php*
php php php php php php*php php@returnphp void
php php php php php php*php/
php php php php protectedphp functionphp php_appendNamespacesphp(php)
php php php php php{
php php php php php php php php php$thisphp-php>getRootElementphp(php)php-php>setAttributephp(php'xmlnsphp:contentphp'php,
php php php php php php php php php php php php php'httpphp:php/php/purlphp.orgphp/rssphp/php1php.php0php/modulesphp/contentphp/php'php)php;
php php php php php}
...
php php php php php php php php php php php php returnphp;
php php php php php php php php php}
php php php php php php php php php$elementphp php=php php$domphp-php>createElementphp(php'contentphp:encodedphp'php)php;
php php php php php php php php php$rootphp-php>appendChildphp(php$elementphp)php;
php php php php php php php php php$cdataphp php=php php$domphp-php>createCDATASectionphp(php$contentphp)php;
php php php php php php php php php$elementphp-php>appendChildphp(php$cdataphp)php;
