...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Feedphp_Writerphp_Extensionphp_WellFormedWebphp_Rendererphp_Entry
...
php php php php php{
php php php php php php php php php$thisphp-php>getRootElementphp(php)php-php>setAttributephp(php'xmlnsphp:wfwphp'php,
php php php php php php php php php php php php php'httpphp:php/php/wellformedwebphp.orgphp/CommentAPIphp/php'php)php;
php php php php php}

php php php php php/php*php*
php php php php php php*php Setphp entryphp commentphp feedphp links
php php php php php php*
...
php php php php php php php php php php php php ifphp php(php$linkphp[php'typephp'php]php php=php=php php'rssphp'php)php php{
php php php php php php php php php php php php php php php php php$flinkphp php=php php$thisphp-php>php_domphp-php>createElementphp(php'wfwphp:commentRssphp'php)php;
php php php php php php php php php php php php php php php php php$textphp php=php php$domphp-php>createTextNodephp(php$linkphp[php'uriphp'php]php)php;
php php php php php php php php php php php php php php php php php$flinkphp-php>appendChildphp(php$textphp)php;
php php php php php php php php php php php php php php php php php$rootphp-php>appendChildphp(php$flinkphp)php;
