...
php/php*php*
php php*php Inputphp feedphp dataphp interface
php php*
php php*php Classesphp implementingphp thisphp interfacephp canphp bephp passephp tophp Zendphp_Feedphp:php:importBuilder
php php*php asphp anphp inputphp dataphp sourcephp forphp thephp Zendphp_Feedphp construction
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Feed
php php*php php@copyrightphp php Copyrightphp php(cphp)php php2php0php0php5php-php2php0php1php0php Zendphp Technologiesphp USAphp Incphp.php php(httpphp:php/php/wwwphp.zendphp.comphp)
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Feedphp_Builderphp_Interface
php{
...
php php php php php php*php/
php php php php publicphp functionphp getHeaderphp(php)php;
...
php php php php php php*php/
php php php php publicphp functionphp getEntriesphp(php)php;
php}
