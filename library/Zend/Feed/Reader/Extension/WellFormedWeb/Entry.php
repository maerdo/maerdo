...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Feedphp_Readerphp_Extensionphp_WellFormedWebphp_Entry
php php php php extendsphp Zendphp_Feedphp_Readerphp_Extensionphp_EntryAbstract
php{
php php php php php/php*php*
php php php php php php*php Getphp thephp entryphp commentphp Uri
php php php php php php*
php php php php php php*php php@returnphp stringphp|null
php php php php php php*php/
php php php php publicphp functionphp getCommentFeedLinkphp(php)
php php php php php{
php php php php php php php php php$namephp php=php php'commentRssphp'php;
...
php php php php php php php php php$dataphp php=php php$thisphp-php>php_xpathphp-php>evaluatephp(php'stringphp(php'php php.php php$thisphp-php>getXpathPrefixphp(php)php php.php php'php/wfwphp:php'php php.php php$namephp php.php php'php)php'php)php;
...
php php php php php{
php php php php php php php php php$thisphp-php>php_xpathphp-php>registerNamespacephp(php'wfwphp'php,php php'httpphp:php/php/wellformedwebphp.orgphp/CommentAPIphp/php'php)php;
php php php php php}
php}
