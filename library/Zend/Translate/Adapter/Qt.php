...
php php*php php@versionphp php php php php$Idphp:php Qtphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Translatephp_Adapterphp_Qtphp extendsphp Zendphp_Translatephp_Adapterphp php{
...
php php php php privatephp php$php_ttagphp php php php php php php php php=php truephp;
php php php php privatephp php$php_dataphp php php php php php php php php=php arrayphp(php)php;

php php php php php/php*php*
php php php php php php*php Loadphp translationphp dataphp php(QTphp filephp readerphp)
...
php php php php php php*php php@paramphp php stringphp php php$filenamephp php QTphp filephp tophp addphp,php fullphp pathphp mustphp bephp givenphp forphp access
...
php php php php php php php php php php php php casephp php'messagephp'php:
php php php php php php php php php php php php php php php php php$thisphp-php>php_sourcephp php=php nullphp;
php php php php php php php php php php php php php php php php php$thisphp-php>php_stagphp php=php falsephp;
php php php php php php php php php php php php php php php php php$thisphp-php>php_ttagphp php=php falsephp;
php php php php php php php php php php php php php php php php php$thisphp-php>php_scontentphp php=php nullphp;
php php php php php php php php php php php php php php php php php$thisphp-php>php_tcontentphp php=php nullphp;
php php php php php php php php php php php php php php php php breakphp;
php php php php php php php php php php php php casephp php'sourcephp'php:
php php php php php php php php php php php php php php php php php$thisphp-php>php_stagphp php=php truephp;
php php php php php php php php php php php php php php php php breakphp;
php php php php php php php php php php php php casephp php'translationphp'php:
php php php php php php php php php php php php php php php php php$thisphp-php>php_ttagphp php=php truephp;
php php php php php php php php php php php php php php php php breakphp;
...
php php php php php php php php php php php php casephp php'translationphp'php:
php php php php php php php php php php php php php php php php ifphp php(php!emptyphp(php$thisphp-php>php_scontentphp)php andphp php!emptyphp(php$thisphp-php>php_tcontentphp)php or
php php php php php php php php php php php php php php php php php php php php php(issetphp(php$thisphp-php>php_dataphp[php$thisphp-php>php_targetphp]php[php$thisphp-php>php_scontentphp]php)php php=php=php=php falsephp)php)php php{
php php php php php php php php php php php php php php php php php php php php php$thisphp-php>php_dataphp[php$thisphp-php>php_targetphp]php[php$thisphp-php>php_scontentphp]php php=php php$thisphp-php>php_tcontentphp;
...
php php php php php php php php ifphp php(php$thisphp-php>php_ttagphp php=php=php=php truephp)php php{
...
php php php php php{
php php php php php php php php returnphp php"Qtphp"php;
php php php php php}
php}
