...
php/php*php*
php php*php Emailphp browserphp typephp matcher
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Http
php php*php php@subpackagephp UserAgent
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Httpphp_UserAgentphp_Emailphp extendsphp Zendphp_Httpphp_UserAgentphp_Desktop
php{
...
php php php php php php php php php'thunderbirdphp'php,
php php php php php)php;
...
php php php php php{
php php php php php php php php returnphp php'emailphp'php;
php php php php php}
php}
