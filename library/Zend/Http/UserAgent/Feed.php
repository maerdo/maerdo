...
php/php*php*
php php*php Feedphp browserphp typephp matcher
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Http
php php*php php@subpackagephp UserAgent
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Httpphp_UserAgentphp_Feedphp extendsphp Zendphp_Httpphp_UserAgentphp_AbstractDevice
php{
...
php php php php php php php php php'bloglinesphp'php,
php php php php php php php php php'everyfeedphp'php,
php php php php php php php php php'feedfetcherphp'php,
php php php php php php php php php'gregariusphp'php,
php php php php php)php;
...
php php php php php{
php php php php php php php php returnphp php'feedphp'php;
php php php php php}
...
php php php php php{
php php php php php php php php php$thisphp-php>setFeaturephp(php'iframesphp'php,php php php php falsephp,php php'productphp_capabilityphp'php)php;
php php php php php php php php php$thisphp-php>setFeaturephp(php'framesphp'php,php php php php php falsephp,php php'productphp_capabilityphp'php)php;
