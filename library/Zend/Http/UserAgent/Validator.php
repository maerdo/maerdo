...
requirephp_oncephp php'Zendphp/Httpphp/UserAgentphp/Desktopphp.phpphp'php;

php/php*php*
php php*php Validatorphp browserphp typephp matcher
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Http
php php*php php@subpackagephp UserAgent
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Httpphp_UserAgentphp_Validatorphp extendsphp Zendphp_Httpphp_UserAgentphp_Desktop
php{
...
php php php php php php php php php'htmlvalidatorphp'php,
php php php php php php php php php'csscheckphp'php,
php php php php php php php php php'cynthiaphp'php,
php php php php php php php php php'htmlparserphp'php,
php php php php php php php php php'validatorphp'php,
php php php php php php php php php'jfouffaphp'php,
php php php php php php php php php'jigsawphp'php,
php php php php php php php php php'wphp3cphp_validatorphp'php,
php php php php php php php php php'wdgphp_validatorphp'php,
php php php php php)php;
...
php php php php php{
php php php php php php php php returnphp php'validatorphp'php;
php php php php php}
php}
