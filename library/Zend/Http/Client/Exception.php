...
php php*php php@subpackagephp Clientphp_Exception
...
php/php*php*
php php*php php@seephp Zendphp_Httpphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Httpphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Httpphp_Clientphp_Exceptionphp extendsphp Zendphp_Httpphp_Exception
php{php}
