...
php/php*php*
php php*php php@seephp Zendphp_Mailphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Mailphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Mailphp_Transportphp_Exceptionphp extendsphp Zendphp_Mailphp_Exception
php{php}
