...
php php*php php@versionphp php php php php$Idphp:php Loginphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Performsphp LOGINphp authentication
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Mail
php php*php php@subpackagephp Protocol
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Mailphp_Protocolphp_Smtpphp_Authphp_Loginphp extendsphp Zendphp_Mailphp_Protocolphp_Smtp
php{
php php php php php/php*php*
php php php php php php*php LOGINphp username
...
php php php php php/php*php*
php php php php php php*php LOGINphp password
php php php php php php*
php php php php php php*php php@varphp string
php php php php php php*php/
...
php php php php php/php*php*
php php php php php php*php Performphp LOGINphp authenticationphp withphp suppliedphp credentials
php php php php php php*
php php php php php php*php php@returnphp void
php php php php php php*php/
...
php php php php php php php php php$thisphp-php>php_sendphp(php'AUTHphp LOGINphp'php)php;
php php php php php php php php php$thisphp-php>php_expectphp(php3php3php4php)php;
php php php php php php php php php$thisphp-php>php_sendphp(basephp6php4php_encodephp(php$thisphp-php>php_usernamephp)php)php;
php php php php php php php php php$thisphp-php>php_expectphp(php3php3php4php)php;
php php php php php php php php php$thisphp-php>php_sendphp(basephp6php4php_encodephp(php$thisphp-php>php_passwordphp)php)php;
