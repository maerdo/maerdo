...
php php*php php@versionphp php php php php$Idphp:php Plainphp.phpphp php2php2php6php5php3php php2php0php1php0php-php0php7php-php2php2php php1php8php:php4php1php:php3php9Zphp mabephp php$
php php*php/
...
php/php*php*
php php*php Performsphp PLAINphp authentication
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Mail
php php*php php@subpackagephp Protocol
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Mailphp_Protocolphp_Smtpphp_Authphp_Plainphp extendsphp Zendphp_Mailphp_Protocolphp_Smtp
php{
php php php php php/php*php*
php php php php php php*php PLAINphp username
...
php php php php php/php*php*
php php php php php php*php PLAINphp password
php php php php php php*
php php php php php php*php php@varphp string
php php php php php php*php/
...
php php php php php/php*php*
php php php php php php*php Performphp PLAINphp authenticationphp withphp suppliedphp credentials
php php php php php php*
php php php php php php*php php@returnphp void
php php php php php php*php/
...
php php php php php php php php php$thisphp-php>php_sendphp(php'AUTHphp PLAINphp'php)php;
php php php php php php php php php$thisphp-php>php_expectphp(php3php3php4php)php;
php php php php php php php php php$thisphp-php>php_sendphp(basephp6php4php_encodephp(php"php\php0php"php php.php php$thisphp-php>php_usernamephp php.php php"php\php0php"php php.php php$thisphp-php>php_passwordphp)php)php;
