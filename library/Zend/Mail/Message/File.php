...
php php*php/
requirephp_oncephp php'Zendphp/Mailphp/Partphp/Filephp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Mailphp_Messagephp_Filephp extendsphp Zendphp_Mailphp_Partphp_Filephp implementsphp Zendphp_Mailphp_Messagephp_Interface
php{
