...
interfacephp Zendphp_Mailphp_Messagephp_Interface
php{
...
php php php php php php*php/
php php php php publicphp functionphp getTopLinesphp(php)php;
...
php php php php php php*php/
php php php php publicphp functionphp hasFlagphp(php$flagphp)php;
...
php php php php php php*php/
php php php php publicphp functionphp getFlagsphp(php)php;
php}