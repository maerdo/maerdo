...
php php*php php@versionphp php php php php$Idphp:php ListFeedphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Representsphp thephp metaphp-feedphp listphp ofphp calendars
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Gdata
php php*php php@subpackagephp Calendar
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Gdataphp_Calendarphp_ListFeedphp extendsphp Zendphp_Gdataphp_Feed
php{
...
php php php php php php*php/
php php php php protectedphp php$php_entryClassNamephp php=php php'Zendphp_Gdataphp_Calendarphp_ListEntryphp'php;
...
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_feedClassNamephp php=php php'Zendphp_Gdataphp_Calendarphp_ListFeedphp'php;
...
php php php php php php php php casephp php$thisphp-php>lookupNamespacephp(php'gCalphp'php)php php.php php'php:php'php php.php php'timezonephp'php;
php php php php php php php php php php php php php$timezonephp php=php newphp Zendphp_Gdataphp_Calendarphp_Extensionphp_Timezonephp(php)php;
php php php php php php php php php php php php php$timezonephp-php>transferFromDOMphp(php$childphp)php;
php php php php php php php php php php php php php$thisphp-php>php_timezonephp php=php php$timezonephp;
