...
php php*php php@versionphp php php php php$Idphp:php Hiddenphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Representsphp thephp gCalphp:hiddenphp elementphp usedphp byphp thephp Calendarphp dataphp API
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Gdata
php php*php php@subpackagephp Calendar
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Gdataphp_Calendarphp_Extensionphp_Hiddenphp extendsphp Zendphp_Gdataphp_Extension
php{

php php php php protectedphp php$php_rootNamespacephp php=php php'gCalphp'php;
php php php php protectedphp php$php_rootElementphp php=php php'hiddenphp'php;
php php php php protectedphp php$php_valuephp php=php nullphp;

php php php php php/php*php*
php php php php php php*php Constructsphp aphp newphp Zendphp_Gdataphp_Calendarphp_Extensionphp_Hiddenphp objectphp.
...
php php php php php php*
php php php php php php*php php@returnphp stringphp Thephp requestedphp attributephp.
php php php php php php*php/
...
php php php php php php*php php@returnphp Zendphp_Gdataphp_Calendarphp_Extensionphp_Hiddenphp Thephp elementphp beingphp modifiedphp.
php php php php php php*php/
