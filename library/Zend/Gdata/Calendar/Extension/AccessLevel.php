...
php php*php php@versionphp php php php php$Idphp:php AccessLevelphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Representsphp thephp gCalphp:accessLevelphp elementphp usedphp byphp thephp Calendarphp dataphp API
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Gdata
php php*php php@subpackagephp Calendar
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Gdataphp_Calendarphp_Extensionphp_AccessLevelphp extendsphp Zendphp_Gdataphp_Extension
php{

php php php php protectedphp php$php_rootNamespacephp php=php php'gCalphp'php;
php php php php protectedphp php$php_rootElementphp php=php php'accesslevelphp'php;
php php php php protectedphp php$php_valuephp php=php nullphp;

php php php php php/php*php*
php php php php php php*php Constructsphp aphp newphp Zendphp_Gdataphp_Calendarphp_Extensionphp_AccessLevelphp objectphp.
php php php php php php*php php@paramphp stringphp php$valuephp php(optionalphp)php Thephp textphp contentphp ofphp thephp elementphp.
php php php php php php*php/
...
php php php php php php php php ifphp php(php$thisphp-php>php_valuephp php!php=php nullphp)php php{
php php php php php php php php php php php php php$elementphp-php>setAttributephp(php'valuephp'php,php php$thisphp-php>php_valuephp)php;
...
php php php php php php php php php php php php php$thisphp-php>php_valuephp php=php php$attributephp-php>nodeValuephp;
...
php php php php php php*
php php php php php php*php php@returnphp stringphp Thephp attributephp beingphp modifiedphp.
php php php php php php*php/
...
php php php php php php*
php php php php php php*php php@paramphp stringphp php$valuephp Thephp desiredphp valuephp forphp thisphp attributephp.
...
php php php php php{
php php php php php php php php returnphp php$thisphp-php>getValuephp(php)php;
php php php php php}
