...
php php*php php@versionphp php php php php$Idphp:php Datephp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Pointphp orphp periodphp ofphp timephp associatedphp withphp anphp eventphp inphp thephp lifecyclephp ofphp the
php php*php resource
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Gdata
php php*php php@subpackagephp DublinCore
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Gdataphp_DublinCorephp_Extensionphp_Datephp extendsphp Zendphp_Gdataphp_Extension
php{

php php php php protectedphp php$php_rootNamespacephp php=php php'dcphp'php;
php php php php protectedphp php$php_rootElementphp php=php php'datephp'php;

php php php php php/php*php*
php php php php php php*php Constructorphp forphp Zendphp_Gdataphp_DublinCorephp_Extensionphp_Datephp which
php php php php php php*php Pointphp orphp periodphp ofphp timephp associatedphp withphp anphp eventphp inphp thephp lifecyclephp ofphp the
php php php php php php*php resource
