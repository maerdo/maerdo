...
php/php*php*
php php*php Accountphp ofphp thephp resource
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Gdata
php php*php php@subpackagephp DublinCore
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Gdataphp_DublinCorephp_Extensionphp_Descriptionphp extendsphp Zendphp_Gdataphp_Extension
php{

php php php php protectedphp php$php_rootNamespacephp php=php php'dcphp'php;
php php php php protectedphp php$php_rootElementphp php=php php'descriptionphp'php;

php php php php php/php*php*
php php php php php php*php Constructorphp forphp Zendphp_Gdataphp_DublinCorephp_Extensionphp_Descriptionphp which
php php php php php php*php Accountphp ofphp thephp resource
