...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_InfoCardphp_Cipherphp_Symmetricphp_Aesphp2php5php6cbcphp_Interface
php{
php php php php publicphp functionphp decryptphp(php$encryptedDataphp,php php$decryptionKeyphp,php php$ivphp_lengthphp php=php nullphp)php;
php}
