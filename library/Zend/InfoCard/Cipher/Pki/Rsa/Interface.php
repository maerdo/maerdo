...
php/php*php*
php php*php Thephp interfacephp whichphp definesphp thephp RSAphp Publicphp-keyphp encryptionphp object
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_InfoCard
php php*php php@subpackagephp Zendphp_InfoCardphp_Cipher
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_InfoCardphp_Cipherphp_Pkiphp_Rsaphp_Interface
php{
...
php php php php php php*php/
php php php php publicphp functionphp decryptphp(php$encryptedDataphp,php php$privateKeyphp,php php$passwordphp php=php nullphp,php php$paddingphp php=php Zendphp_InfoCardphp_Cipherphp_Pkiphp_Adapterphp_Abstractphp:php:NOphp_PADDINGphp)php;
php}
