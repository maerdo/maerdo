...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_InfoCardphp_Xmlphp_KeyInfophp_Interface
php{
php php php php php/php*php*
php php php php php php*php Returnphp anphp objectphp representingphp aphp KeyInfophp dataphp type
php php php php php php*
php php php php php php*php php@returnphp Zendphp_InfoCardphp_Xmlphp_KeyInfo
php php php php php php*php/
php php php php publicphp functionphp getKeyInfophp(php)php;
php}
