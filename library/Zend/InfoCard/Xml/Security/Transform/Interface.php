...
php/php*php*
php php*php Interfacephp forphp XMLphp Securityphp Transforms
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_InfoCard
php php*php php@subpackagephp Zendphp_InfoCardphp_Xmlphp_Security
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_InfoCardphp_Xmlphp_Securityphp_Transformphp_Interface
php{
php php php php php/php*php*
php php php php php php*php Transformphp thephp givenphp XMLphp stringphp accordingphp tophp thephp transformphp rules
php php php php php php*php implementedphp byphp thephp objectphp usingphp thisphp interface
...
php php php php php php*php/
php php php php publicphp functionphp transformphp(php$strXmlDataphp)php;
php}
