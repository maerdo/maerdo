...
php/php*php*
php php*php Zendphp_InfoCardphp_Xmlphp_Securityphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/InfoCardphp/Xmlphp/Securityphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_InfoCardphp_Xmlphp_Securityphp_Transformphp_Exceptionphp extendsphp Zendphp_InfoCardphp_Xmlphp_Securityphp_Exception
php{
php}
