...
php/php*php*
php php*php Zendphp_Ldapphp_Nodephp_Schemaphp_ObjectClassphp_Interfacephp providesphp aphp contractphp forphp schemaphp objectClassesphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Ldap
php php*php php@subpackagephp Schema
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Ldapphp_Nodephp_Schemaphp_ObjectClassphp_Interface
php{
...
php php php php php php*php/
php php php php publicphp functionphp getMustContainphp(php)php;
...
php php php php php php*php php@returnphp array
php php php php php php*php/
php php php php publicphp functionphp getMayContainphp(php)php;
...
php php php php php php*php php@returnphp array
php php php php php php*php/
php php php php publicphp functionphp getParentClassesphp(php)php;
php}