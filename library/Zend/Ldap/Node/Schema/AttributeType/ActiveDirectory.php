...
php/php*php*
php php*php Zendphp_Ldapphp_Nodephp_Schemaphp_AttributeTypephp_ActiveDirectoryphp providesphp accessphp tophp thephp attributephp type
php php*php schemaphp informationphp onphp anphp Activephp Directoryphp serverphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Ldap
php php*php php@subpackagephp Schema
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Ldapphp_Nodephp_Schemaphp_AttributeTypephp_ActiveDirectoryphp extendsphp Zendphp_Ldapphp_Nodephp_Schemaphp_Item
...
php php php php php{
php php php php php php php php returnphp php$thisphp-php>ldapdisplaynamephp[php0php]php;
php php php php php}
