...
php/php*php*
php php*php Zendphp_Ldapphp_Filterphp_Stringphp providesphp aphp simplephp customphp stringphp filterphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Ldap
php php*php php@subpackagephp Filter
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Ldapphp_Filterphp_Stringphp extendsphp Zendphp_Ldapphp_Filterphp_Abstract
php{
php php php php php/php*php*
php php php php php php*php Thephp filterphp.
...
php php php php php php*php/
php php php php publicphp functionphp php_php_constructphp(php$filterphp)
php php php php php{
...
php php php php php{
php php php php php php php php returnphp php'php(php'php php.php php$thisphp-php>php_filterphp php.php php'php)php'php;
php php php php php}
php}