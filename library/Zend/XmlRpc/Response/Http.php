...
php/php*php*
php php*php Zendphp_XmlRpcphp_Response
php php*php/
requirephp_oncephp php'Zendphp/XmlRpcphp/Responsephp.phpphp'php;

php/php*php*
php php*php HTTPphp response
php php*
php php*php php@usesphp Zendphp_XmlRpcphp_Response
...
php php*php/
classphp Zendphp_XmlRpcphp_Responsephp_Httpphp extendsphp Zendphp_XmlRpcphp_Response
php{
php php php php php/php*php*
php php php php php php*php Overridephp php_php_toStringphp(php)php tophp sendphp HTTPphp Contentphp-Typephp header
...
php php php php php php php php php php php php headerphp(php'Contentphp-Typephp:php textphp/xmlphp;php charsetphp=php'php php.php strtolowerphp(php$thisphp-php>getEncodingphp(php)php)php)php;
