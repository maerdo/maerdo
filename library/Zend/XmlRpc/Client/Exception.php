...
php php*php/
requirephp_oncephp php'Zendphp/XmlRpcphp/Exceptionphp.phpphp'php;


php/php*php*
php php*php Basephp classphp forphp allphp Zendphp_XmlRpcphp_Clientphp_php*php exceptions
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_XmlRpc
php php*php php@subpackagephp Client
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_XmlRpcphp_Clientphp_Exceptionphp extendsphp Zendphp_XmlRpcphp_Exception
php{php}
