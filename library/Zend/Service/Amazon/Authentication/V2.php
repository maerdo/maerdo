...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Servicephp_Amazonphp_Authenticationphp_Vphp2php extendsphp Zendphp_Servicephp_Amazonphp_Authentication
php{
...
php php php php php/php*php*
php php php php php php*php Typephp ofphp httpphp request
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_httpMethodphp php=php php"POSTphp"php;
...
php php php php php/php*php*
php php php php php php*php Setphp httpphp requestphp typephp tophp POSTphp orphp GET
php php php php php php*php php@paramphp php$methodphp string
php php php php php php*php/
php php php php publicphp functionphp setHttpMethodphp(php$methodphp php=php php"POSTphp"php)php php{
php php php php php php php php php$thisphp-php>php_httpMethodphp php=php strtoupperphp(php$methodphp)php;
php php php php php}

php php php php php/php*php*
php php php php php php*php Getphp thephp currentphp httpphp requestphp type
php php php php php php*php php@returnphp string
php php php php php php*php/
php php php php publicphp functionphp getHttpMethodphp(php)
php php php php php{
php php php php php php php php returnphp php$thisphp-php>php_httpMethodphp;
php php php php php}
...
php php php php php{
php php php php php php php php php$dataphp php=php php$thisphp-php>php_httpMethodphp php.php php"php\nphp"php;
php php php php php php php php php$dataphp php.php=php parsephp_urlphp(php$urlphp,php PHPphp_URLphp_HOSTphp)php php.php php"php\nphp"php;
php php php php php php php php php$dataphp php.php=php php(php'php'php php=php=php php$pathphp php=php parsephp_urlphp(php$urlphp,php PHPphp_URLphp_PATHphp)php)php php?php php'php/php'php php:php php$pathphp;
...
php php php php php php php php php$hmacphp php=php Zendphp_Cryptphp_Hmacphp:php:computephp(php$thisphp-php>php_secretKeyphp,php php'SHAphp2php5php6php'php,php php$dataphp,php Zendphp_Cryptphp_Hmacphp:php:BINARYphp)php;
