...
php/php*php*
php php*php Zendphp_Servicephp_Amazonphp/Exception
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Servicephp_Amazonphp_Sqsphp_Exceptionphp extendsphp Zendphp_Servicephp_Amazonphp_Exception
php{php}
