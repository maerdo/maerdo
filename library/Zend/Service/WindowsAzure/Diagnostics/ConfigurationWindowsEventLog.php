...
php/php*php*
php php*php php@seephp Zendphp_Servicephp_WindowsAzurephp_Diagnosticsphp_LogLevel
php php*php/
requirephp_oncephp php'Zendphp/Servicephp/WindowsAzurephp/Diagnosticsphp/LogLevelphp.phpphp'php;
...
php php*php php@propertyphp php php php stringphp php php php ScheduledTransferLogLevelFilterphp php php php php php php php Scheduledphp transferphp logphp levelphp filter
...
php php*php/
classphp Zendphp_Servicephp_WindowsAzurephp_Diagnosticsphp_ConfigurationWindowsEventLog
...
php	php php*php php@paramphp	stringphp	php$scheduledTransferLogLevelFilterphp	Scheduledphp transferphp logphp levelphp filter
php	php php*php/
php php php php publicphp functionphp php_php_constructphp(php$bufferQuotaInMBphp php=php php0php,php php$scheduledTransferPeriodInMinutesphp php=php php0php,php php$scheduledTransferLogLevelFilterphp php=php Zendphp_Servicephp_WindowsAzurephp_Diagnosticsphp_LogLevelphp:php:UNDEFINEDphp)
php php php php php{php	
...
php php php php php php php php php php php php php'scheduledtransferloglevelfilterphp'php php php php php=php>php php$scheduledTransferLogLevelFilterphp,
...
php	php php*
php php	php php*php php@paramphp	stringphp	php$filterphp	Eventphp logphp filter
php	php php*php/
php php php php publicphp functionphp addSubscriptionphp(php$filterphp)
php php php php php{
php php php php php php php php php$thisphp-php>php_dataphp[php'subscriptionsphp'php]php[php$filterphp]php php=php php$filterphp;
php php php php php}
...
php php	php php*php php@paramphp	stringphp	php$filterphp	Eventphp logphp filter
php	php php*php/
php php php php publicphp functionphp removeSubscriptionphp(php$filterphp)
php php php php php{
php php php php php php php php ifphp php(issetphp(php$thisphp-php>php_dataphp[php'subscriptionsphp'php]php[php$filterphp]php)php)php php{
php php php php php php php php php php php php unsetphp(php$thisphp-php>php_dataphp[php'subscriptionsphp'php]php[php$filterphp]php)php;
