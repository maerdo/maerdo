...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
abstractphp classphp Zendphp_Servicephp_WindowsAzurephp_Diagnosticsphp_ConfigurationObjectBaseAbstract
php{
...
php php php php php php php php throwphp newphp Zendphp_Servicephp_WindowsAzurephp_Diagnosticsphp_Exceptionphp(php"Unknownphp propertyphp:php php"php php.php php$namephp)php;
php php php php php}
