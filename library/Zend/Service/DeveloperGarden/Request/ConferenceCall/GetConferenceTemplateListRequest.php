...
php php*php php@versionphp php php php php$Idphp:php GetConferenceTemplateListRequestphp.phpphp php2php0php1php6php6php php2php0php1php0php-php0php1php-php0php9php php1php9php:php0php0php:php1php7Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Servicephp_DeveloperGardenphp_Requestphp_ConferenceCallphp_GetConferenceTemplateListRequest
...
php php php php php php*php/
php php php php publicphp functionphp php_php_constructphp(php$environmentphp,php php$ownerIdphp php=php nullphp)
php php php php php{
php php php php php php php php parentphp:php:php_php_constructphp(php$environmentphp)php;
php php php php php php php php php$thisphp-php>setOwnerIdphp(php$ownerIdphp)php;
php php php php php}
...
php php php php php php*php php@returnphp Zendphp_Servicephp_DeveloperGardenphp_Requestphp_ConferenceCallphp_GetConferenceTemplateListRequest
php php php php php php*php/
