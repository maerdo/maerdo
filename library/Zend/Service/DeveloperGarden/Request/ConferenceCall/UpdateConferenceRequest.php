...
php php*php php@versionphp php php php php$Idphp:php UpdateConferenceRequestphp.phpphp php2php0php1php6php6php php2php0php1php0php-php0php1php-php0php9php php1php9php:php0php0php:php1php7Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Servicephp_DeveloperGardenphp_Requestphp_ConferenceCallphp_UpdateConferenceRequest
php php php php extendsphp Zendphp_Servicephp_DeveloperGardenphp_Requestphp_RequestAbstract
php{
php php php php php/php*php*
php php php php php php*php conferencephp id
...
php php php php php php*php/
php php php php publicphp functionphp php_php_constructphp(php$environmentphp,php php$conferenceIdphp,php php$ownerIdphp php=php nullphp,
php php php php php php php php Zendphp_Servicephp_DeveloperGardenphp_ConferenceCallphp_ConferenceDetailphp php$conferenceDetailsphp php=php nullphp,
...
php php php php php php php php php php php php php php-php>setOwnerIdphp(php$ownerIdphp)
...
php php php php php/php*php*
php php php php php php*php setsphp php$conferenceId
php php php php php php*
php php php php php php*php php@paramphp stringphp php$conferenceId
php php php php php php*php php@returnphp Zendphp_Servicephp_DeveloperGardenphp_Requestphp_ConferenceCallphp_UpdateConferenceRequest
php php php php php php*php/
php php php php publicphp functionphp setConferenceIdphp(php$conferenceIdphp)
php php php php php{
php php php php php php php php php$thisphp-php>conferenceIdphp=php php$conferenceIdphp;
...
php php php php php php*php php@returnphp Zendphp_Servicephp_DeveloperGardenphp_Requestphp_ConferenceCallphp_CreateConferenceRequest
php php php php php php*php/
php php php php publicphp functionphp setOwnerIdphp(php$ownerIdphp php=php nullphp)
php php php php php{
