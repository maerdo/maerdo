...
php php*php php@versionphp php php php php$Idphp:php ResponseAbstractphp.phpphp php2php0php1php6php6php php2php0php1php0php-php0php1php-php0php9php php1php9php:php0php0php:php1php7Zphp bkarwinphp php$
php php*php/

php/php*php*
php php*php php@seephp Zendphp_Servicephp_DeveloperGardenphp_Responsephp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Servicephp/DeveloperGardenphp/Responsephp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
abstractphp classphp Zendphp_Servicephp_DeveloperGardenphp_Responsephp_ResponseAbstract
php{
php php php php php/php*php*
php php php php php php*php errorCode
php php php php php php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php publicphp php$errorCodephp php=php nullphp;

php php php php php/php*php*
php php php php php php*php errorMessage
php php php php php php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php publicphp php$errorMessagephp php=php nullphp;

php php php php php/php*php*
php php php php php php*php parsephp thephp tokenphp dataphp andphp throwsphp exceptions
php php php php php php*
...
php php php php php{
php php php php php php php php returnphp php$thisphp-php>errorCodephp;
php php php php php}
...
php php php php php{
php php php php php php php php returnphp php$thisphp-php>errorMessagephp;
php php php php php}
...
php php php php php{
php php php php php php php php returnphp php(php$thisphp-php>errorCodephp php=php=php=php null
php php php php php php php php php php php php php php|php|php php$thisphp-php>errorCodephp php=php=php php'php0php0php0php0php'php)php;
php php php php php}
...
php php php php php{
php php php php php php php php returnphp php(php$thisphp-php>errorCodephp php!php=php=php null
php php php php php php php php php php php php php php php php php&php&php php$thisphp-php>errorCodephp php!php=php php'php0php0php0php0php'php)php;
php php php php php}
php}
