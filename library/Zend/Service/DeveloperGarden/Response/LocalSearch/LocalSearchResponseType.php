...
php php*php php@versionphp php php php php$Idphp:php LocalSearchResponseTypephp.phpphp php2php0php1php6php6php php2php0php1php0php-php0php1php-php0php9php php1php9php:php0php0php:php1php7Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Servicephp_DeveloperGardenphp_Responsephp_LocalSearchphp_LocalSearchResponseType
php php php php extendsphp Zendphp_Servicephp_DeveloperGardenphp_Responsephp_BaseType
php{
php php php php php/php*php*
php php php php php php*php containsphp thephp resultphp object
