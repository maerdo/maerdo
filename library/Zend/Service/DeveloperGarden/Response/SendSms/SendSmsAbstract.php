...
php php*php php@versionphp php php php php$Idphp:php SendSmsAbstractphp.phpphp php2php0php1php6php6php php2php0php1php0php-php0php1php-php0php9php php1php9php:php0php0php:php1php7Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
abstractphp classphp Zendphp_Servicephp_DeveloperGardenphp_Responsephp_SendSmsphp_SendSmsAbstract
...
php php php php php php php php php$retValuephp php=php nullphp;
php php php php php php php php ifphp php(php$thisphp-php>returnphp instanceofphp stdClassphp)php php{
php php php php php php php php php php php php php$retValuephp php=php php$thisphp-php>returnphp-php>descriptionphp;
php php php php php php php php php}
php php php php php php php php returnphp php$retValuephp;
php php php php php}
