...
php php*php php@versionphp php php php php$Idphp:php USAddressVerificationphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/

php/php*php*php Zendphp_Servicephp_StrikeIronphp_Basephp php*php/
requirephp_oncephp php'Zendphp/Servicephp/StrikeIronphp/Basephp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Servicephp_StrikeIronphp_USAddressVerificationphp extendsphp Zendphp_Servicephp_StrikeIronphp_Base
php{
...
php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php php'wsdlphp'php php php php php php=php>php php'httpphp:php/php/wsphp.strikeironphp.comphp/zfphp1php.StrikeIronphp/USAddressVerificationphp4php_php0php?WSDLphp'php)php;
php}
