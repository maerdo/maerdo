...
php/php*php*
php php*php Nonphp-Persistentphp Authphp Storage
php php*
php php*php Sincephp HTTPphp Authenticationphp happensphp againphp onphp eachphp requestphp,php thisphp willphp alwaysphp be
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Authphp_Storagephp_NonPersistentphp implementsphp Zendphp_Authphp_Storagephp_Interface
php{
php php php php php/php*php*
php php php php php php*php Holdsphp thephp actualphp authphp data
php php php php php php*php/
