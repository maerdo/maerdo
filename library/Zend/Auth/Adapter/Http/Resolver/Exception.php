...
php/php*php*
php php*php php@seephp Zendphp_Authphp_Exception
php php*php/
requirephp_oncephp php'Zendphp/Authphp/Exceptionphp.phpphp'php;


php/php*php*
php php*php HTTPphp Authphp Resolverphp Exception
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Auth
php php*php php@subpackagephp Zendphp_Authphp_Adapterphp_Http
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Authphp_Adapterphp_Httpphp_Resolverphp_Exceptionphp extendsphp Zendphp_Authphp_Exception
php{php}
