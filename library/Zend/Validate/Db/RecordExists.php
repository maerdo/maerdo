...
php php*php php@versionphp php php php php$Idphp:php RecordExistsphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Confirmsphp aphp recordphp existsphp inphp aphp tablephp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Validate
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Validatephp_Dbphp_RecordExistsphp extendsphp Zendphp_Validatephp_Dbphp_Abstract
php{
...
php php php php php php php php php php php php php$thisphp-php>php_errorphp(selfphp:php:ERRORphp_NOphp_RECORDphp_FOUNDphp)php;
