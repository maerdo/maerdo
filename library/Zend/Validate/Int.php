...
php php*php php@versionphp php php php php$Idphp:php Intphp.phpphp php2php2php6php6php8php php2php0php1php0php-php0php7php-php2php5php php1php4php:php5php0php:php4php6Zphp thomasphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Validatephp_Intphp extendsphp Zendphp_Validatephp_Abstract
php{
php php php php constphp INVALIDphp php=php php'intInvalidphp'php;
php php php php constphp NOTphp_INTphp php=php php'notIntphp'php;
...
php php php php php php php php selfphp:php:NOTphp_INTphp php=php>php php"php'php%valuephp%php'php doesphp notphp appearphp tophp bephp anphp integerphp"php,
...
php php php php php php*
php php php php php php*php Returnsphp truephp ifphp andphp onlyphp ifphp php$valuephp isphp aphp validphp integer
php php php php php php*
php php php php php php*php php@paramphp php stringphp|integerphp php$value
...
php php php php php php php php php php php php php$localephp php php php php php php php php=php localeconvphp(php)php;
php php php php php php php php php php php php php$valueFilteredphp php=php strphp_replacephp(php$localephp[php'decimalphp_pointphp'php]php,php php'php.php'php,php php$valuephp)php;
php php php php php php php php php php php php php$valueFilteredphp php=php strphp_replacephp(php$localephp[php'thousandsphp_sepphp'php]php,php php'php'php,php php$valueFilteredphp)php;

php php php php php php php php php php php php ifphp php(strvalphp(intvalphp(php$valueFilteredphp)php)php php!php=php php$valueFilteredphp)php php{
php php php php php php php php php php php php php php php php php$thisphp-php>php_errorphp(selfphp:php:NOTphp_INTphp)php;
php php php php php php php php php php php php php php php php returnphp falsephp;
php php php php php php php php php php php php php}

php php php php php php php php php}php elsephp php{
php php php php php php php php php php php php tryphp php{
php php php php php php php php php php php php php php php php ifphp php(php!Zendphp_Localephp_Formatphp:php:isIntegerphp(php$valuephp,php arrayphp(php'localephp'php php=php>php php$thisphp-php>php_localephp)php)php)php php{
php php php php php php php php php php php php php php php php php php php php php$thisphp-php>php_errorphp(selfphp:php:NOTphp_INTphp)php;
