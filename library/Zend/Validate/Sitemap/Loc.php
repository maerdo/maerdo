...
php php*php php@versionphp php php php php$Idphp:php Locphp.phpphp php2php2php6php6php8php php2php0php1php0php-php0php7php-php2php5php php1php4php:php5php0php:php4php6Zphp thomasphp php$
php php*php/
...
php/php*php*
php php*php Validatesphp whetherphp aphp givenphp valuephp isphp validphp asphp aphp sitemapphp php<locphp>php value
php php*
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Validatephp_Sitemapphp_Locphp extendsphp Zendphp_Validatephp_Abstract
php{
php php php php php/php*php*
php php php php php php*php Validationphp keyphp forphp notphp valid
php php php php php php*
php php php php php php*php/
php php php php constphp NOTphp_VALIDphp php=php php'sitemapLocNotValidphp'php;
php php php php constphp INVALIDphp php php php=php php'sitemapLocInvalidphp'php;
...
php php php php php php php php selfphp:php:NOTphp_VALIDphp php=php>php php"php'php%valuephp%php'php isphp nophp validphp sitemapphp locationphp"php,
...
php php php php php/php*php*
php php php php php php*php Validatesphp ifphp aphp stringphp isphp validphp asphp aphp sitemapphp location
php php php php php php*
php php php php php php*php php@linkphp httpphp:php/php/wwwphp.sitemapsphp.orgphp/protocolphp.phpphp#locdefphp php<locphp>
php php php php php php*
...
php php php php php php php php php$resultphp php=php Zendphp_Uriphp:php:checkphp(php$valuephp)php;
