...
php/php*php*
php php*php Abstractphp classphp forphp cloudphp decorators
php php*
...
php php*php/
abstractphp classphp Zendphp_Tagphp_Cloudphp_Decoratorphp_Cloud
php{
...
php php php php php/php*php*
php php php php php php*php Renderphp aphp listphp ofphp formattedphp tags
php php php php php php*
php php php php php php*php php@paramphp php arrayphp php$tags
php php php php php php*php php@returnphp string
php php php php php php*php/
php php php php abstractphp publicphp functionphp renderphp(arrayphp php$tagsphp)php;
php}
