...
php php*php php@versionphp php php php php$Idphp:php Diskphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Cachephp_Backendphp_ZendServerphp_Diskphp extendsphp Zendphp_Cachephp_Backendphp_ZendServerphp implementsphp Zendphp_Cachephp_Backendphp_Interface
php{
...
php php php php php{
php php php php php php php php ifphp php(php!functionphp_existsphp(php'zendphp_diskphp_cachephp_storephp'php)php)php php{
php php php php php php php php php php php php Zendphp_Cachephp:php:throwExceptionphp(php'Zendphp_Cachephp_ZendServerphp_Diskphp backendphp hasphp tophp bephp usedphp withinphp Zendphp Serverphp environmentphp.php'php)php;
...
php php php php php{
php php php php php php php php ifphp php(zendphp_diskphp_cachephp_storephp(php$thisphp-php>php_optionsphp[php'namespacephp'php]php php.php php'php:php:php'php php.php php$idphp,
...
php php php php php{
php php php php php php php php returnphp zendphp_diskphp_cachephp_fetchphp(php$thisphp-php>php_optionsphp[php'namespacephp'php]php php.php php'php:php:php'php php.php php$idphp)php;
php php php php php}
...
php php php php php{
php php php php php php php php returnphp zendphp_diskphp_cachephp_deletephp(php$thisphp-php>php_optionsphp[php'namespacephp'php]php php.php php'php:php:php'php php.php php$idphp)php;
php php php php php}
...
php php php php php{
php php php php php php php php zendphp_diskphp_cachephp_clearphp(php$thisphp-php>php_optionsphp[php'namespacephp'php]php)php;
php php php php php}
php}
