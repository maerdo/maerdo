...
php/php*php*
php php*php php@seephp Zendphp_Controllerphp_Exception
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Controllerphp_Actionphp_Exceptionphp extendsphp Zendphp_Controllerphp_Exception
php{php}
