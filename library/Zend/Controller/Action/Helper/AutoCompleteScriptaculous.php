...
php php*php php@versionphp php php php php$Idphp:php AutoCompleteScriptaculousphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php/php*php*
php php*php Createphp andphp sendphp Scriptaculousphp-compatiblephp autocompletionphp lists
php php*
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Controllerphp_Actionphp_Helperphp_AutoCompleteScriptaculousphp extendsphp Zendphp_Controllerphp_Actionphp_Helperphp_AutoCompletephp_Abstract
php{
...
php php php php php{
php php php php php php php php ifphp php(php!isphp_arrayphp(php$dataphp)php php&php&php php!isphp_scalarphp(php$dataphp)php)php php{
...
php php php php php{
php php php php php php php php ifphp php(php!php$thisphp-php>validateDataphp(php$dataphp)php)php php{
...
php php php php php php php php php php php php throwphp newphp Zendphp_Controllerphp_Actionphp_Exceptionphp(php'Invalidphp dataphp passedphp forphp autocompletionphp'php)php;
php php php php php php php php php}

php php php php php php php php php$dataphp php=php php(arrayphp)php php$dataphp;
php php php php php php php php php$dataphp php=php php'php<ulphp>php<liphp>php'php php.php implodephp(php'<php/liphp>php<liphp>php'php,php php$dataphp)php php.php php'<php/liphp><php/ulphp>php'php;

php php php php php php php php ifphp php(php!php$keepLayoutsphp)php php{
php php php php php php php php php php php php php$thisphp-php>disableLayoutsphp(php)php;
php php php php php php php php php}
