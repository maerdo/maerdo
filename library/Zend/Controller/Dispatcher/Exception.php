...
php/php*php*php Zendphp_Controllerphp_Exceptionphp php*php/
requirephp_oncephp php'Zendphp/Controllerphp/Exceptionphp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Controllerphp_Dispatcherphp_Exceptionphp extendsphp Zendphp_Controllerphp_Exception
php{php}
