...
php/php*php*
php php*php Zendphp_Controllerphp_Responsephp_Http
php php*
php php*php HTTPphp responsephp forphp controllers
php php*
...
php php*php/
classphp Zendphp_Controllerphp_Responsephp_Httpphp extendsphp Zendphp_Controllerphp_Responsephp_Abstract
php{
php}
