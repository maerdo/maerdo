...
php/php*php*
php php*php Interfacephp forphp Zendphp_Soapphp_Wsdlphp_Strategyphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Soap
php php*php php@subpackagephp Wsdl
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Soapphp_Wsdlphp_Strategyphp_Interface
php{
php php php php php/php*php*
php php php php php php*php Methodphp acceptsphp thephp currentphp WSDLphp contextphp filephp.
php php php php php php*
php php php php php php*php php@paramphp php<typephp>php php$context
php php php php php php*php/
php php php php publicphp functionphp setContextphp(Zendphp_Soapphp_Wsdlphp php$contextphp)php;
...
php php php php php php*php/
php php php php publicphp functionphp addComplexTypephp(php$typephp)php;
php}