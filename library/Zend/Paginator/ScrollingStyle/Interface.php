...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Paginatorphp_ScrollingStylephp_Interface
php{
...
php php php php php php*php/
php php php php publicphp functionphp getPagesphp(Zendphp_Paginatorphp php$paginatorphp,php php$pageRangephp php=php nullphp)php;
php}