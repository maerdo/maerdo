...
php php*php php@versionphp php php php php$Idphp:php FormFilephp.phpphp php2php3php3php4php3php php2php0php1php0php-php1php1php-php1php5php php1php5php:php3php3php:php2php2Zphp ramonphp php$
php php*php/

php/php*php*
php php*php php@seephp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_AbstractClassFile
php php*php/
requirephp_oncephp php'Zendphp/Toolphp/Projectphp/Contextphp/Zfphp/AbstractClassFilephp.phpphp'php;
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_FormFilephp extendsphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_AbstractClassFile
php{

php php php php php/php*php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_formNamephp php=php php'Basephp'php;

php php php php php/php*php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_filesystemNamephp php=php php'formNamephp'php;
...
php php php php php{
php php php php php php php php php$thisphp-php>php_formNamephp php=php php$thisphp-php>php_resourcephp-php>getAttributephp(php'formNamephp'php)php;
php php php php php php php php php$thisphp-php>php_filesystemNamephp php=php ucfirstphp(php$thisphp-php>php_formNamephp)php php.php php'php.phpphp'php;
...
php php php php php php php php php php php php php'formNamephp'php php=php>php php$thisphp-php>getFormNamephp(php)
...
php php php php php{
php php php php php php php php returnphp php'FormFilephp'php;
php php php php php}

php php php php publicphp functionphp getFormNamephp(php)
php php php php php{
php php php php php php php php returnphp php$thisphp-php>php_formNamephp;
php php php php php}

php php php php publicphp functionphp getContentsphp(php)
php php php php php{

php php php php php php php php php$classNamephp php=php php$thisphp-php>getFullClassNamephp(php$thisphp-php>php_formNamephp,php php'Formphp'php)php;
...
php php php php php php php php php php php php php php php php php php php php php'extendedClassphp'php php=php>php php'Zendphp_Formphp'php,
...
php php php php php php php php php php php php php php php php php php php php php php php php php php php php php'bodyphp'php php=php>php php'php/php*php Formphp Elementsphp php&php Otherphp Definitionsphp Herephp php.php.php.php php*php/php'php,
