...
php php*php php@versionphp php php php php$Idphp:php TestApplicationControllerFilephp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_TestApplicationControllerFilephp extendsphp Zendphp_Toolphp_Projectphp_Contextphp_Filesystemphp_File
php{

php php php php php/php*php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_forControllerNamephp php=php php'php'php;
...
php php php php php{
php php php php php php php php returnphp php'TestApplicationControllerFilephp'php;
php php php php php}

php php php php php/php*php*
php php php php php php*php initphp(php)
php php php php php php*
php php php php php php*php php@returnphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_TestApplicationControllerFile
php php php php php php*php/
...
php php php php php php php php php$thisphp-php>php_filesystemNamephp php=php ucfirstphp(php$thisphp-php>php_forControllerNamephp)php php.php php'ControllerTestphp.phpphp'php;
...
php php php php php php php php php$classNamephp php=php php$filterphp-php>filterphp(php$thisphp-php>php_forControllerNamephp)php php.php php'ControllerTestphp'php;
