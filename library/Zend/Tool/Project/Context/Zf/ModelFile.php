...
php php*php php@versionphp php php php php$Idphp:php ModelFilephp.phpphp php2php3php4php8php4php php2php0php1php0php-php1php2php-php1php0php php0php3php:php5php7php:php5php9Zphp mjhphp_caphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_ModelFilephp extendsphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_AbstractClassFile
php{

php php php php php/php*php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_modelNamephp php=php php'Basephp'php;

php php php php php/php*php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_filesystemNamephp php=php php'modelNamephp'php;
...
php php php php php{
php php php php php php php php php$thisphp-php>php_modelNamephp php=php php$thisphp-php>php_resourcephp-php>getAttributephp(php'modelNamephp'php)php;
php php php php php php php php php$thisphp-php>php_filesystemNamephp php=php ucfirstphp(php$thisphp-php>php_modelNamephp)php php.php php'php.phpphp'php;
...
php php php php php php php php php php php php php'modelNamephp'php php=php>php php$thisphp-php>getModelNamephp(php)
...
php php php php php{
php php php php php php php php returnphp php'ModelFilephp'php;
php php php php php}

php php php php publicphp functionphp getModelNamephp(php)
php php php php php{
php php php php php php php php returnphp php$thisphp-php>php_modelNamephp;
php php php php php}

php php php php publicphp functionphp getContentsphp(php)
php php php php php{

php php php php php php php php php$classNamephp php=php php$thisphp-php>getFullClassNamephp(php$thisphp-php>php_modelNamephp,php php'Modelphp'php)php;
