...
php php*php php@versionphp php php php php$Idphp:php ModuleDirectoryphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_ModuleDirectoryphp extendsphp Zendphp_Toolphp_Projectphp_Contextphp_Filesystemphp_Directory
php{
...
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_filesystemNamephp php=php php'moduleDirectoryphp'php;

php php php php php/php*php*
php php php php php php*php initphp(php)
php php php php php php*
php php php php php php*php php@returnphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_ControllerFile
php php php php php php*php/
php php php php publicphp functionphp initphp(php)
php php php php php{
php php php php php php php php php$thisphp-php>php_filesystemNamephp php=php php$thisphp-php>php_moduleNamephp php=php php$thisphp-php>php_resourcephp-php>getAttributephp(php'moduleNamephp'php)php;
...
php php php php php{
php php php php php php php php returnphp php'ModuleDirectoryphp'php;
php php php php php}
...
php php php php php php php php php php php php php'moduleNamephp'php php=php>php php$thisphp-php>getModuleNamephp(php)
php php php php php php php php php php php php php)php;
php php php php php}

php php php php php/php*php*
php php php php php php*php getModuleNamephp(php)
php php php php php php*
php php php php php php*php php@returnphp string
php php php php php php*php/
