...
php php*php php@versionphp php php php php$Idphp:php DataDirectoryphp.phpphp php2php0php0php9php6php php2php0php1php0php-php0php1php-php0php6php php0php2php:php0php5php:php0php9Zphp bkarwinphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Toolphp_Projectphp_Contextphp_Zfphp_DocsDirectoryphp extendsphp Zendphp_Toolphp_Projectphp_Contextphp_Filesystemphp_Directory
php{

php php php php php/php*php*
php php php php php php*php php@varphp string
php php php php php php*php/
php php php php protectedphp php$php_filesystemNamephp php=php php'docsphp'php;
...
php php php php php{
php php php php php php php php returnphp php'DocsDirectoryphp'php;
php php php php php}

php php php php publicphp functionphp createphp(php)php{
