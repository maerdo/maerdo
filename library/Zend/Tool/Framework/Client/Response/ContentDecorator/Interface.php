...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Toolphp_Frameworkphp_Clientphp_Responsephp_ContentDecoratorphp_Interface
php{

php php php php publicphp functionphp getNamephp(php)php;

php php php php publicphp functionphp decoratephp(php$contentphp,php php$decoratorValuephp)php;
