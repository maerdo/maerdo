...
php php*php php@versionphp php php php php$Idphp:php Interfacephp.phpphp php2php3php4php8php4php php2php0php1php0php-php1php2php-php1php0php php0php3php:php5php7php:php5php9Zphp mjhphp_caphp php$
php php*php/
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
interfacephp Zendphp_Toolphp_Frameworkphp_Metadataphp_Interface
php{
...
php php php php php php*
php php php php php php*php/
php php php php publicphp functionphp getValuephp(php)php;
