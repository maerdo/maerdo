...
php/php*php*
php php*php Classphp implementingphp workingphp withphp Azurephp queriesphp inphp aphp structuredphp way
php php*
php php*php TODOphp Lookphp intophp preventingphp aphp queryphp injectionphp attackphp.
php php*
php php*php php@categoryphp php php Zend
php php*php php@packagephp php php php Zendphp_Cloud
php php*php php@subpackagephp DocumentService
...
php php*php php@licensephp php php php httpphp:php/php/frameworkphp.zendphp.comphp/licensephp/newphp-bsdphp php php php php Newphp BSDphp License
php php*php/
classphp Zendphp_Cloudphp_DocumentServicephp_Factoryphp extendsphp Zendphp_Cloudphp_AbstractFactory
php{
php php php php constphp DOCUMENTphp_ADAPTERphp_KEYphp php=php php'documentphp_adapterphp'php;
...
php php php php php php*php/
php php php php protectedphp staticphp php$php_adapterInterfacephp php=php php'Zendphp_Cloudphp_DocumentServicephp_Adapterphp'php;
...
php php php php php/php*php*
php php php php php php*php Retrievephp anphp adapterphp instance
php php php php php php*
...
php php php php php{
php php php php php php php php php$adapterphp php=php parentphp:php:php_getAdapterphp(selfphp:php:DOCUMENTphp_ADAPTERphp_KEYphp,php php$optionsphp)php;
...
php php php php php php php php php php php php php php php php php'Classphp mustphp bephp specifiedphp usingphp thephp php\php'php'
php php php php php php php php php php php php php php php php php.php selfphp:php:DOCUMENTphp_ADAPTERphp_KEYphp php.php php'php\php'php keyphp'
