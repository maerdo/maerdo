...
class Maerdo_Model_Componentdatabasemodule extends Maerdo_Model_Abstract {
	...
	public function __construct() {
		$this->_mapper=new Maerdo_Model_Mappers_Componentdatabasemodule();    	
     ...
     *
     * @return  Maerdo_Model_Mappers_Componentdatabasemodule     *
     */       
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new  Maerdo_Model_Mappers_Componentdatabasemodule());
        }
        return $this->_mapper;
    }
