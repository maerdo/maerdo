...
class Maerdo_Model_Componenttranslate extends Maerdo_Model_Abstract {
	...
	public function __construct() {
		$this->_mapper=new Maerdo_Model_Mappers_Componenttranslate();    	
     ...
     *
     * @return  Maerdo_Model_Mappers_Componenttranslate     *
     */       
    public function getMapper()
    {
        if (null === $this->_mapper) {
            $this->setMapper(new  Maerdo_Model_Mappers_Componenttranslate());
        }
        return $this->_mapper;
    }
